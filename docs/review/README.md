...
| # | 维度 | 起点 | 阶段 1 后 | 阶段 2 后 | 阶段 3 后 | 阶段 4 后 | 关键发现 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 01 | [Agent Loop](./01-agent-loop.md) | **4 / 5** | **4 / 5** | **4.5 / 5** 🟢 | **4.5 / 5** | **4.5 / 5** | 阶段 3 + 4: Task 41 显式 replay API + Task 40 故障注入工具 |
| 02 | [工具边界](./02-tool-boundary.md) | **4 / 5** | **4.5 / 5** 🟢 | **4.5 / 5** | **4.5 / 5** | **5.0 / 5** 🟢 | 阶段 4: Task 43 工具注册表 TOOL_REGISTRY 统一 schema/validator/permission |
| 03 | [上下文可控](./03-context-control.md) | **4 / 5** | **4 / 5** | **4.5 / 5** 🟢 | **4.5 / 5** | **5.0 / 5** 🟢 | 阶段 4: Task 44 截断决策可解释 + Task 45 自适应压缩 4 策略 |
| 04 | [权限策略](./04-permission.md) | **4 / 5** | **4 / 5** | **4.5 / 5** 🟢 | **5.0 / 5** 🟢 | **5.0 / 5** | 阶段 3: Task 32 三类 HITL + Task 34 Pydantic schema + Task 33 E2E |
| 05 | [失败恢复](./05-failure-recovery.md) | **4 / 5** | **4.5 / 5** 🟢 | **4.5 / 5** | **4.5 / 5** | **5.0 / 5** 🟢 | 阶段 4: Task 37 Fallback 策略 + Task 40 故障注入 |
| 06 | [评测体系](./06-evaluation.md) | **1 / 5** | **3 / 5** 🟢 | **3 / 5** | **4.5 / 5** 🟢 | **4.5 / 5** | 阶段 3: Task 28 CI 集成 + Task 29 人评抽样 + Task 30 可视化面板 |
| 07 | [可观测性](./07-observability.md) | **3 / 5** | **3 / 5** | **4 / 5** 🟢 | **4.5 / 5** 🟢 | **4.5 / 5** | 阶段 3: Task 31 Prometheus /metrics 端点 + Task 35 慢查询 dashboard |
| 08 | [HITL](./08-hitl.md) | **3 / 5** | **3 / 5** | **4 / 5** 🟢 | **4.5 / 5** 🟢 | **4.5 / 5** | 阶段 3: Task 32 三类 HITL 异常(decision/input/progress_confirm) |
| 09 | [成本/延迟](./09-cost-latency.md) | **3 / 5** | **3 / 5** | **4 / 5** 🟢 | **4.5 / 5** 🟢 | **5.0 / 5** 🟢 | 阶段 4: Task 36 自适应模型 + Task 39 月度成本 dashboard |
